package com.example.aklah.CategorySearch;
 ...
 @Override
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        observable.subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Observer<Category>() {
            ...
            @Override
            public void onComplete() {
                categoryAdapter = new CategoryAdapter(getActivity(),categories,CategoryAdapter.ALL,R.layout.all_category_list_row,CategoryAdapter.FRAGMENT_CATEGORY_SEARCH);
